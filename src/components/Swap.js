...
import { Form, InputGroup, Dropdown, DropdownButton, Button, Row, Spinner } from "react-bootstrap";
...
const Swap = () => {
  ...
  const swapHandler = async (e) => {
    ...
    const _token = inputToken === 'DAPP' ? tokens[0] : tokens[1]
    await swap(provider, amm, _token, inputToken, _inputAmount, dispatch)
