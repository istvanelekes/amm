...
contract AMM {
    ...
    // Determine how many token2 tokens need to deposited when depositing liquididty for token1
    function calculateToken2Deposit(uint256 _token1Amount) public view returns(uint256 token2Amount) {
        token2Amount = (token2Balance * _token1Amount) / token1Balance;    
    }

    // Determine how many token1 tokens need to deposited when depositing liquididty for token2
